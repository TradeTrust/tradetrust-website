describe("Endorse Owner", () => {
  it("should go to verify page and upload a file", async () => {
    cy.visit("/verify");
  ...
  it("should import account 2 and connect all metamask wallets to dapp", async () => {
  ...
  it("should endorse owner successfully", async () => {

  ...
  tokenRegistry: [
    {
      // Endorse Owner
      merkleRoot:
        "0x80d8454e62cf2a68158f590b05d058b6c8f495bdecd7393bb64fa95f647c4d73",
      ...defaultToken,
    },
    {
      // Nominate Owner
      ...defaultToken,
      merkleRoot:
        "0x31f63da7bbdb1fe5af64e2302e0e0fe0e3e118d4176845f2ce30240ac58ce6ef",
      holder: ADDRESS_EXAMPLE_2,
    },
    {
      // Surrender
      merkleRoot:
        "0xe4f6e95c6b3a7ea69b04b4e2771debbb884db69e07fc788749d4fe433dd54ded",
      ...defaultToken,
    },
    {
      // Transfer Holder
      merkleRoot:
        "0x32e4fdcccd92061b4df9e5de1393cbb5f2219abb1f632304aea102fcefa619d4",
      ...defaultToken,
    },
  ],
};
...
shell.exec(
  `${oaCLI_PATH} deploy title-escrow-factory -n local -k ${ACCOUNT_KEY}`
);

...
test("Load document from action should work when url is valid", async (t) => {
  ...
  //   type: "DOCUMENT",
  //   payload: {
  //     uri: `https://raw.githubusercontent.com/TradeTrust/tradetrust-website/refs/heads/master/src/test/fixture/amoy/ebl-amoy.json`,

...
const ViewEndorsementChainButton = Selector(
  "#endorsement-chain-button"
).withText("View Endorsement Chain");
const EndorsementChainTitle = Selector(
  "[data-testid='endorsement-chain-title']"
).withText("Endorsement Chain");
const EndorsementChainAddressMinter = Selector(
  "[data-testid='address-entity']"
).withText("0x1245e5B64D785b25057f7438F715f4aA5D965733");
const EndorsementChainAddress1 = Selector(
  "[data-testid='address-entity']"
).withText("0x8d366250A96deBE81C8619459a503a0eEBE33ca6");
const EndorsementChainAddress2 = Selector(
  "[data-testid='address-entity']"
).withText("0x90264b594B8dc2225cb7D05a14e78483BAc7FBF7");
const DocumentIssuedAction = Selector("[data-testid='action-title']").withText(
  "Document has been issued"
);

const EndorseNomineeAction = Selector("[data-testid='action-title']").withText(
  "Endorse change of ownership"
);

const TransferHoldershipAction = Selector(
  "[data-testid='action-title']"
).withText("Transfer holdership");
const ChangeOwnershipAction = Selector("[data-testid='action-title']").withText(
  "Change Owners"
);

const SurrenderToIssuerAction = Selector(
  "[data-testid='action-title']"
).withText("Document surrendered to issuer");
const SurrenderAcceptedAction = Selector(
  "[data-testid='action-title']"
).withText("Surrender of document accepted");

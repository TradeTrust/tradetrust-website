...
export const getIssuersIdentities = async issuers => Promise.all(issuers.map(resolveIssuerIdentity));

export const issuersIdentitiesAllVerified = (identities = []) => identities.every(identity => identity.identified);

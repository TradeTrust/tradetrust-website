...
describe("Fetch Escrow Transfers", () => {
  ...
  describe("fetch from title escrow transfers", () => {
    it("should return parsed transfer logs in valid format", async () => {
      const escrowTransfers = await fetchEscrowTransfers(
        goerliProvider,
        "0xAAb472d3706E0E7F8Fb4354EADe34F2c43dDb279"
      );
    ...
    it("should return parsed transfer logs in valid format", async () => {
      const titleEscrow = TitleEscrow__factory.connect(
        "0xAAb472d3706E0E7F8Fb4354EADe34F2c43dDb279",
        goerliProvider
      );
      const log = {
        blockNumber: 7836281,
        blockHash:
          "0x62f2ad472722a5ee2d78994608d668d8c7ab75dbc5419992c07900ed4dcf6ccc",
        transactionIndex: 18,
        removed: false,
      ...
      expect(JSON.stringify(parsedLogs)).toEqual(
  ...
  describe("fetch from title escrow owner transfers", () => {
    it("should return parsed transfer logs in valid format", async () => {
      ...
      const ownerTransfers = await fetchOwnerTransfers(
        titleEscrow,
        goerliProvider
      );
  ...
  describe("fetch from title escrow holder transfers", () => {
    it("should return parsed transfer logs in valid format", async () => {
      ...
      const holderTransfers = await fetchHolderTransfers(
        titleEscrow,
        goerliProvider
      );

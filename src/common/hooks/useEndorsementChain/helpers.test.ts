...
describe("Test all endorsement chain helpers", () => {
  ...
  describe("mergeTransferTransactions merges duplicated transactions", () => {
    it("Merge Initial Transactions", () => {
      ...
      const mergedTransaction = mergeDuplicatedTransactions(initialTransactions);
    ...
    it("Merge Transfer Owners Transactions", () => {
      ...
      const mergedTransaction = mergeDuplicatedTransactions(transferTransactions);
      expect(mergedTransaction).toEqual({
        type: "TRANSFER_BENEFICIARY",
        owner: "0x8d366250A96deBE81C8619459a503a0eEBE33ca6",
        blockNumber: 7835693,
    ...
    it("Merge Surrender Accepted Transactions", () => {
      ...
      const mergedTransaction = mergeDuplicatedTransactions(burnTransactions);

...
} from "@govtechsg/ethers-contract-hook";
...
export const TokenInformationContextProvider: FunctionComponent<TokenInformationContextProviderProps> =
  ({ children }) => {
    ...
    const { isInterfaceType: isTitleEscrow } = useSupportsInterface(
      titleEscrow,
      "0x079dff60"
    );
    ...
    const { call: getBeneficiary, value: beneficiary } =
      useContractFunctionHook(titleEscrow, "beneficiary");

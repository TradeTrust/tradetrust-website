  ...
  switch (true) {
    case item === "Upcoming Event":
      return allEvents.filter((event) =>
        isFuture(new Date(event.attributes.date))
      );
    case item === "Past Event":
      return allEvents.filter((event) =>
        isPast(new Date(event.attributes.date))
      );
    default:
      return allEvents;
  }
    ...
    <>
      <Helmet>
        <meta
          ...
          content="Check out TradeTrust's upcoming and past events."
        />
        <meta
        ...
        <div className="flex flex-wrap py-4 -mx-4">
          <div className="w-full px-4 lg:w-9/12">
            ...
            {filteredPosts.length > 0 ? (
              ...
              <h5 className="font-base font-medium text-cloud-500">

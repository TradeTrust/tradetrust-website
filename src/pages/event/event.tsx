...
// massage data by adding slug (base on filename generated by netlify cms)
const getEvents = (context: __WebpackModuleApi.RequireContext) => {
...
const rawEvents = getEvents(require.context("../../../cms/event/", false, /\.md$/));

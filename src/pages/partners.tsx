  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`${window.location.origin}/partners`}
        />
        <title>TradeTrust - Partners</title>
      </Helmet>
      <Page title="Partners">
        <p className="font-medium mb-5">
          Here are the partners we have worked with you may want to contact. Do
          note that being on this list implies that these companies have
          demonstrated knowledge of implementing TradeTrust, but does not imply
          endorsement by TradeTrust.
        </p>
        <a
        ...
        >
          <Button
            className="bg-cerulean-500 text-white hover:bg-cerulean-800 mb-5"
            size={ButtonSize.SM}
          >
            Be a Partner
          </Button>

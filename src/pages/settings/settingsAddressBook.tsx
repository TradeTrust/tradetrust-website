  ...
  <>
    <Helmet>
      <meta
        ...
        content="Add a local address book to resolve addresses."
      />
      <meta
        property="og:description"
        content="a local address book to resolve addresses."
      />
      <meta
        property="og:title"
      ...
      <meta
        property="og:url"
        content={`${window.location.origin}/settings/address-book`}
      />
    ...
    <div className="container py-8">
      ...
      <div className="flex-1 flex-col">
        ...
        <p className="mb-5 text-cloud-800">
          Please select an address book to view.{" "}
        </p>
      </div>

  ...
  <>
    <Helmet>
      <meta
        ...
        content="Add third party’s endpoint to resolve addresses."
      />
      <meta
      ...
      <meta
        property="og:url"
        content={`${window.location.origin}/settings/address-resolver`}
      />
    ...
    <div className="container py-8">
      ...
      <div className="flex-1 flex-col">
        ...
        <p className="mb-5 text-cloud-800">
          Add third party’s endpoint to resolve addresses.
        </p>
      </div>
      <AddressResolver />
    </div>

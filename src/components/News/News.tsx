...
const importedArticles = require.context(
  "./../../../cms/article/",
  false,
  /\.md$/
);
const importedNewsletters = require.context(
  "./../../../cms/newsletter/",
  false,
  /\.md$/
);
const importedPartnerNews = require.context(
  "./../../../cms/partner-news/",
  false,
  /\.md$/
);
const importedPressReleases = require.context(
  "./../../../cms/press-release/",
  false,
  /\.md$/
);
const importedSpeeches = require.context(
  "./../../../cms/speech/",
  false,
  /\.md$/
);
...
const newsletters = getCmsContentWithSlug(
  importedNewsletters,
  NewsTag.NEWSLETTER
);
const partnerNews = getCmsContentWithSlug(
  importedPartnerNews,
  NewsTag.PARTNER_NEWS
);
const pressReleases = getCmsContentWithSlug(
  importedPressReleases,

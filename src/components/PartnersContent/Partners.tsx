...
export const sortPartnersData = (
  allPartnersData: PartnerDataSingle[]
): PartnerDataSingle[] => {
  return allPartnersData.sort((a, b) =>
    a.attributes.companyName.localeCompare(b.attributes.companyName)
  ); // this sort it alphabetically by companyName
};

const allImportedPartners = require.context(
  "./../../../cms/partners",
  false,
  /\.md$/
);

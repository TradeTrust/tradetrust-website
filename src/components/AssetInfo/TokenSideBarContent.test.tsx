...
describe("tokenSideBarContent", () => {
  ...
  it("should render TokenSideBarHolder view", () => {
    const wrapper = mount(
      <TokenSideBarContent userWalletAddress="0xA" holderAddress="0xA" beneficiaryAddress="" registryAddress="" />
    );
  ...
  it("should render TokenSideBarBeneficiary view", () => {
    const wrapper = mount(
      <TokenSideBarContent userWalletAddress="0xA" holderAddress="" beneficiaryAddress="0xA" registryAddress="" />
    );
  ...
  it("should render TokenSideBarBeneficiary view", () => {
    const wrapper = mount(
      <TokenSideBarContent userWalletAddress="0xA" holderAddress="" beneficiaryAddress="0xC" registryAddress="" />
    );

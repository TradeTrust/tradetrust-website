...
import { utils as oaUtils, WrappedDocument, v3, OAv4 } from "@tradetrust-tt/tradetrust";
...
export const getV4IdentityVerificationText = (document: WrappedDocument<OAv4.OpenAttestationDocument>): string => {

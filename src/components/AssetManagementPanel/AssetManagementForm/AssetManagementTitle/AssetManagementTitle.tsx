...
export const AssetManagementTitle: FunctionComponent<AssetManagementTitleProps> =
  ({ setFormActionNone, formAction, disabled }) => {
    return (
      <div className="flex flex-wrap my-4">
        <div
          className={`mb-2 ${
            disabled
              ? "text-cloud-200 cursor-default"
              : "text-cloud-500 cursor-pointer"
          }`}
        ...
        >
          ...
          <h3 className="font-bold text-cloud-800">
            ...
            {formAction === AssetManagementActions.AcceptSurrendered && (
              <>Accept Surrender of Document</>
            )}
            {formAction === AssetManagementActions.RejectSurrendered && (

...
import { DeleteAddressResolver } from "./OverlayContent/DeleteAddressResolver";
import {
  MessageTitle,
...
### Overlay (DeleteAddressResolver)

<Preview>
  <Story name="DeleteAddressResolver">
    {() => {
      const deleteAddress = () => {
      ...
      return (
        <OverlayStorybookWrapper>
          <DeleteAddressResolver title="Delete Address Resolver" name="Swift" deleteAddress={deleteAddress} />
        </OverlayStorybookWrapper>
      );
    }}
  </Story>

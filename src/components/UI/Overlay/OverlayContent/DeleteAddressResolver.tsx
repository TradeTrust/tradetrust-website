...
interface DeleteAddressResolverProps extends OverlayContentProps {
  name: string;
  deleteAddress: () => void;
}

export const DeleteAddressResolver = styled(({ name, deleteAddress, ...props }: DeleteAddressResolverProps) => {

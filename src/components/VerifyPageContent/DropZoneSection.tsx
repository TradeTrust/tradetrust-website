...
const DraggableDemoCertificate: FunctionComponent<DraggableDemoCertificateProps> =
  (props) => (
            ...
            <div className="w-2/3 lg:w-1/2 xl:w-64 mr-auto px-4 inline-block box-content">
              <div className="relative aspect-square">
                ...
                <div
                  ...
                  draggable
                  onDragStart={(e) =>
                    e.dataTransfer.setData(getDemoCert(props.chainId), "true")
                  }
                >
                  <a
      ...
      <div className="w-full md:w-1/2">
        <div
          ...
          onDrop={(event) => {
            if (
              event.dataTransfer &&
              event.dataTransfer.getData(getDemoCert(currentChainId))
            ) {

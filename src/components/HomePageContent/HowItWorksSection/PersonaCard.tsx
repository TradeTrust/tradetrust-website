...
export const PersonaCard: React.FunctionComponent<PersonaProps> = ({
  personaIndex,
  persona,
}) => {
  ...
  const onOverlayHandler = (modalContent: Persona) => {
    showOverlay(
      <PersonaModal personaIndex={personaIndex} persona={modalContent} />
    );
  };
  ...
  return (
    <div
      className="flex flex-col m-4 lg:w-6/12 lg:m-0 lg:mb-8"
    ...
    >
      <div className="min-h-220 lg:flex lg:items-center">
        ...
        <div className="flex flex-col items-center lg:items-start lg:justify-start">
          ...
          <p className="text-base text-center mx-5 lg:mx-0 lg:text-left lg:min-h-90">
            {description}
          </p>
          <p

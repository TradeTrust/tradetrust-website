...
const DescriptionSection: FunctionComponent = () => {
  ...
  return (
    <section id="welcome" className="bg-cerulean-50 text-gray-700 md:pt-16">
      <Background className="relative bg-135% bg-right-bottom bg-no-repeat py-16 md:bg-auto md:bg-right-top">

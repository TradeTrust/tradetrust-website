...
export const FaqSelect: FunctionComponent = () => {
  const boxStyle =
    "flex flex-col items-center rounded px-12 py-6 bg-white shadow-md mr-5 mb-6";
  return (
    <div className="flex flex-wrap">
      <div className="w-full lg:w-2/3">
        <p className="my-9 max-w-[766px]">
          Below are some of the answers to the most common questions. If you
          still cannot find the answer you are looking for, feel free to{" "}
          <FormSgContactLink>contact us</FormSgContactLink>.
        </p>

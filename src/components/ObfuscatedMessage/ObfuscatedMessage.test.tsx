...
describe("ObfuscatedMessage", () => {
  it("should display obfuscated message if the obfuscatedData is present", () => {
    const container = render(<ObfuscatedMessage document={OfuscatedDocument as WrappedDocument} />);
  ...
  it("should not display obfuscated message if the obfuscatedData is not present", () => {
    const container = render(<ObfuscatedMessage document={UnobfuscatedDocument as WrappedDocument} />);

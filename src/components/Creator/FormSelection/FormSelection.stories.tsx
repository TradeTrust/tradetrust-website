...
const formTypes: FormTypes[] = ["Transferable", "Non-Transferable"];
export const FormSelectionSample: FunctionComponent = () => {
  return (
    <>
...
export default {
  title: "Creator/FormSelection",
  component: FormSelectionSample,
  parameters: {
    componentSubtitle: "Form Selection",
  },
};

...
module.exports = {
  ...
  "browsers": [
    "remote chrome:headless --no-native --disable-web-security --user-data-dir=/tmp/chrome --autoplay-policy=no-user-gesture-required --allow-insecure-localhost --ignore-certificate-errors"
  ],
  "concurrency": 4,

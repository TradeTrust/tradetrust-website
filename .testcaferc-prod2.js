...
module.exports = {
  ...
  "browsers": [
    "chrome:headless --autoplay-policy=no-user-gesture-required --allow-insecure-localhost --ignore-certificate-errors --disable-features=LocalNetworkAccessChecks --unsafely-treat-insecure-origin-as-secure=http://127.0.0.1:8545,http://localhost:8545"
  ],
  "concurrency": 1,
  ...
  "screenshots": {
    ...
    "pathPattern": "${USERAGENT}/${FIXTURE}/test-${TEST_INDEX}-attempt-${QUARANTINE_ATTEMPT}-${FILE_INDEX}.png",
    "takeOnFails": true,
    "fullPage": true
  }
}
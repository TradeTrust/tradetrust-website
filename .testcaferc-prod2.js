...
module.exports = {
  ...
  "browsers": [
    "chrome:headless --disable-web-security --user-data-dir=/tmp/chrome --autoplay-policy=no-user-gesture-required  --allow-insecure-localhost --ignore-certificate-errors"
  ],
  "concurrency": 4,
